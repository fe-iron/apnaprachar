...
$sql = "SELECT * FROM book_services WHERE service_for='app development'";
      ...
      <div class="card my-5 shadow">
        <nav class="navbar navbar-light  venue-registration border-bottom">
          ...
          <div class="form-inline">
              ...
              <div class="filter-item" id="myDIV" style="display: none;">
                <form>
                  <div class="form-group">
                    ...
                    <input type="date" name="date" class="form-control mb-3" id="filter_date" placeholder="date" onchange="filter('date', 'app development')">
                  </div>
                  <div class="form-group">
                    <label for="formGroupExampleInput2" class="mb-1">Status</label>
                    <select class="form-control"  onchange="filter('status', 'app development')" id="filter_status">
            ...
            <a href="web_app_development_table.php" class="btn btn-info">Back</a>
          </div>
        </nav>
