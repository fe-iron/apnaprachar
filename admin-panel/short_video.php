...
$sql = "SELECT * FROM book_services WHERE service_for='video'";
              ...
              <div class="filter-item" id="myDIV" style="display: none;">
                <form>
                  <div class="form-group">
                    ...
                    <input type="date" name="date" class="form-control mb-3" id="filter_date" placeholder="date" onchange="filter('date', 'video')">
                  </div>
                  <div class="form-group">
                    <label for="formGroupExampleInput2" class="mb-1">Status</label>
                    <select class="form-control"  onchange="filter('status', 'video')" id="filter_status">
              ...
              <table class="table table-bordered">
                <thead class="border">
                  <tr>
                    ...
                    <th scope="col" class="border-right text-center">Candidate Image</th>
                    <th scope="col" class="border-right text-center">Video</th>
