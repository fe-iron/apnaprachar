<?php include_once'inc/head.php'; 
  ...
  $sql = "SELECT * FROM book_services WHERE service_for='instagram'";
      ...
      <div class="col-md-11">
        <div class="card my-5 shadow">
          <nav class="navbar navbar-light  venue-registration border-bottom">
            <a class="h4 text-dark font-weight-bold pt-2">Instagram Graphic Design </a>
            <div class="form-inline">
              ...
              <div class="filter-item" id="myDIV" style="display: none;">
                <form>
                  <div class="form-group">
                    ...
                    <input type="date" name="date" class="form-control mb-3" id="filter_date" placeholder="date" onchange="filter('date', 'instagram')">
                  </div>
                  <div class="form-group">
                    <label for="formGroupExampleInput2" class="mb-1">Status</label>
                    <select class="form-control"  onchange="filter('status', 'instagram')" id="filter_status">
              ...
              <a href="graphic_design_table.php" class="btn btn-info">Back</a>
            </div>
          </nav>
            ...
            <div class="table-responsive">
              <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <th scope="col" class="border-right text-center">Party</th>
                    <th scope="col" class="border-right text-center">Occasion</th>
                    <th scope="col" class="border-right text-center">Candidate Imgae</th>
                    <th scope="col" class="border-right text-center">Belonging Image</th>
                      ...
                      if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            if($row['status']){
                              ...
                              $text= $text. '<td class="border-right border-left text-center"><a href="#" class="btn btn-sm btn-info" onclick="complete('.$row['id'].', `instagram_graphic.php`);">Processing</a></td>';
                            }
