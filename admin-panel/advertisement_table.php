...
if(isset($_POST['service_for'])){
  $service_for = $_POST['service_for'];

  $sql = "SELECT * FROM book_services WHERE service_for='".$service_for."'";
      ...
      <div class="col-md-11 col-sm-12">
        <div class="card my-5 shadow">
          <nav class="navbar navbar-light  venue-registration border-bottom">
            <a class="h4 text-dark font-weight-bold pt-2"><?php echo ucwords($service_for); ?></a>
            ...
            <div class="form-inline">
              ...
              <div class="filter-item" id="myDIV" style="display: none;">
                <form>
                  <div class="form-group">
                    ...
                    <input type="date" name="date" class="form-control mb-3" id="filter_date" placeholder="date" onchange="filter('date', '<?php echo $service_for; ?>')">
                  </div>
                  <div class="form-group">
                    <label for="formGroupExampleInput2" class="mb-1">Status</label>
                    <select class="form-control"  onchange="filter('status', '<?php echo $service_for; ?>')" id="filter_status">
              ...
              <a href="advertisement.php" class="btn btn-info">Back</a>
            </div>
            ...
            <div class="table-responsive">
              <table class="table table-bordered">
                <thead class="border">
                  <tr>
                    <?php
                    if($service_for == "facebook Sponsored Post" || $service_for == "instagram sponsored post" || $service_for == "youtube advertisement" || $service_for == "google advertisement"){ ?>
