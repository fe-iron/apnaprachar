...
$sql = "SELECT * FROM book_services WHERE service_for='youtube'";
              ...
              <div class="filter-item" id="myDIV" style="display: none;">
                <form>
                  <div class="form-group">
                    ...
                    <input type="date" name="date" class="form-control mb-3" id="filter_date" placeholder="date" onchange="filter('date', 'youtube')">
                  </div>
                  <div class="form-group">
                    <label for="formGroupExampleInput2" class="mb-1">Status</label>
                    <select class="form-control"  onchange="filter('status', 'youtube')" id="filter_status">
                ...
                if ($result->num_rows > 0) {
                  ...
                  while($row = $result->fetch_assoc()) {
                    ...
                    if($row['status']){
                      ...
                      $text= $text. '<td class="border-right border-left text-center"><a href="#" class="btn btn-sm btn-info" onclick="complete('.$row['id'].', `youtube_graphic.php`);">Processing</a></td>';
                    }
