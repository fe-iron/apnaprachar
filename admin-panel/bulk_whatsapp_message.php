...
$sql = "SELECT * FROM message_calls WHERE service_for='bulk_whatsapp_message'";
    ...
    <div class="row justify-content-center">
      ...
      <div class="card my-5 shadow">
        <nav class="navbar navbar-light  venue-registration border-bottom">
          <a class="h4 text-dark font-weight-bold pt-2">Bulk Whatsapp Message  </a>
          <div class="form-inline">
              ...
              <div class="filter-item" id="myDIV" style="display: none;">
                <form>
                  <div class="form-group">
                    ...
                    <input type="date" name="date" class="form-control mb-3" id="filter_date" placeholder="date" onchange="filter_message('date', 'bulk_whatsapp_message')">
                  </div>
                  <div class="form-group">
                    <label for="formGroupExampleInput2" class="mb-1">Status</label>
                    <select class="form-control"  onchange="filter_message('status', 'bulk_whatsapp_message')" id="filter_status">
            ...
            <a href="message_call_table.php" class="btn btn-info">Back</a>
          </div>
        </nav>
            ...
            <table class="table table-bordered">
              <thead class="border">
                ...
                <th scope="col" class="border-right text-center">Status</th>
                  ...
                  <th scope="col" class="border-right text-center">No. of Message</th>
                  <th scope="col" class="border-right text-center">Message Character</th>
                      ...
                      if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            if($row['status']){
                              ...
                              $text= $text. '<td class="border-right border-left text-center"><a href="#" class="btn btn-sm btn-info" onclick="my_complete('.$row['id'].', `bulk_whatsapp_message.php`);">Processing</a></td>';
                            }
