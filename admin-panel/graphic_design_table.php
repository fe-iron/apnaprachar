      ...
      <div class="col-md-10">
        <div class="card my-5 shadow">
          ...
          <div class="card-body text-center">
              <a href="facebook_graphic.php" class="btn btn-dark mx-1 mb-2">Facebook</a>
              <a href="instagram_graphic.php" class="btn btn-dark mx-1 mb-2">Instagram</a>
              <a href="youtube_graphic.php" class="btn btn-dark mx-1 mb-2">Youtube</a>
              <a href="twitter_graphic.php" class="btn btn-dark mx-1 mb-2">Twitter </a>
              <a href="linkedin_graphic.php" class="btn btn-dark mx-1 mb-2">LinkedIn </a>
          </div>
        </div>
      </div>
    </div>
