<?php include_once'inc/head.php'; 
  ...
  $sql = "SELECT * FROM book_services WHERE service_for='linkedin'";
      ...
      <div class="col-md-11">
        <div class="card my-5 shadow">
          <nav class="navbar navbar-light  venue-registration border-bottom">
            <a class="h4 text-dark font-weight-bold pt-2">LinkedIn Graphic Design </a>
              ...
              <div class="filter-item" id="myDIV" style="display: none;">
                <form>
                  <div class="form-group">
                    ...
                    <input type="date" name="date" class="form-control mb-3" id="filter_date" placeholder="date" onchange="filter('date', 'linkedin')">
                  </div>
                  <div class="form-group">
                    <label for="formGroupExampleInput2" class="mb-1">Status</label>
                    <select class="form-control"  onchange="filter('status', 'linkedin')" id="filter_status">
                      ...
                      if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            if($row['status']){
                              ...
                              $text= $text. '<td class="border-right border-left text-center"><a href="#" class="btn btn-sm btn-info" onclick="complete('.$row['id'].', `linkedin_graphic.php`);">Processing</a></td>';
                            }
